document.addEventListener("DOMContentLoaded", function () {
    ...
    petForm.addEventListener("submit", function (event) {
        ...
        const fields = [
            { id: "petName", message: "Por favor, preencha o nome do pet.", maxLength: maxNameLength },
            { id: "racaPet", message: "Por favor, preencha a raça do pet.", maxLength: maxRaceLength },
            { id: "descricao", message: "Por favor, preencha a descrição do pet.", maxLength: maxDescriptionLength },
            { id: "petAge", message: "Por favor, preencha a idade do pet." },
            { id: "petType", message: "Por favor, selecione o sexo do pet." },
            { id: "petFinalidade", message: "Por favor, selecione a finalidade do cadastro." }
        ];
        ...
        reader.onload = function (event) {
            ...
            const petFinalidade = document.getElementById("petFinalidade").value.trim();
